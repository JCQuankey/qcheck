...
SITE_URL = "https://qcheck.quankey.xyz/"
...
def to_html(rows: list) -> str:
    return (
        ...
        "<a href='#roadmap'>Roadmap</a><a href='#pilot'>Paid pilot</a>"
        ...
        "<div class='btns'>"
        "<a class='btn primary' href='#start'>Install qcheck</a>"
        "<a class='btn ghost' href='#pilot'>Discuss a paid pilot</a>"
        "</div></div>"
        # evidence artifact (terminal)
        "<div class='terminal'><div class='bar'><i></i><i></i><i></i></div>"
        "<div class='body'>"
        "<div><span class='p'>$</span> qcheck verify bell.py</div>"
        ...
        "</div></div>"
        "</div></header>"
        # installation and current product availability
        "<section class='section' id='start'><div class='wrap'>"
        "<p class='eyebrow'>Get started</p><h2>Run a local review</h2>"
        "<p>Install <code>qcheck-quantum</code> from PyPI, then review your file:</p>"
        "<pre><code>pip install qcheck-quantum\nqcheck verify your-circuit.py --json</code></pre>"
        "<p>The CLI and GitHub Action are free and open source. qcheck reviews "
        "your code locally without executing it or sending telemetry.</p>"
        f"<p><a href='{GITHUB}/blob/main/docs/AGENTS.md'>Agent and CI examples</a></p>"
        "</div></section>"
        # what qcheck checks
        ...
        "<div class='steps'>"
        "<div class='step'><div class='when'>Available</div><h3>CLI &amp; GitHub Action</h3>"
        "<p>Static review for Qiskit, OpenQASM, PennyLane and Cirq, with JSON "
        "and SARIF output.</p></div>"
        "<div class='step'><div class='when'>Planned</div><h3>MCP</h3>"
        "<p>An agent-callable interface to static review.</p></div>"
        "<div class='step'><div class='when'>Under evaluation</div><h3>Hosted verification</h3>"
        "<p>Reproducible checks and checked repairs for a defined task contract. "
        "Not available as a self-service product today.</p></div>"
        "</div></div></section>"
        # qualify demand before promising a hosted product or taking payment
        "<section class='section' id='pilot'><div class='wrap'>"
        "<p class='eyebrow'>Pilot enquiry</p><h2>Have a recurring quantum-code failure?</h2>"
        "<p class='lead'>Tell us what fails in your agent or CI workflow and what "
        "evidence you need to trust a correction.</p>"
        "<p>Start with a non-confidential summary. We will agree the scope, "
        "deliverables and price before accepting payment. Hosted verification "
        "and checked repairs are being evaluated; this is a pilot enquiry, "
        "not access to an available hosted service.</p>"
        "<a class='btn primary' href='mailto:dev@quankey.xyz?subject=qcheck%20paid%20pilot'>"
        "Discuss a paid pilot</a>"
        "</div></section>"
        "</main>"
        # footer
