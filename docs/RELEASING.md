...
configured (`0.2.0` shipped on 2026-07-04; `0.5.0` shipped; `0.6.0` shipped; `0.7.0` shipped; `0.8.0` shipped; `0.9.0` shipped; `0.10.0` is the next release). The steps below are kept for
