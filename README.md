...
**Catch broken AI-generated quantum code before you run it.**

LLMs write quantum code that fails to run **40–70% of the time** one-shot
(QuanBench+ 2026: Qiskit 59.5% / PennyLane 42.9% pass; QCoder: GPT-4o-mini ~70%
failure). `qcheck` is a tiny, dependency-free CLI that statically verifies
...
An AI agent (or a developer pasting from ChatGPT) produces a Qiskit/QASM snippet.
...
Designed to be parsed by an AI agent that just generated the code, or by a CI
...
tell you whether AI-generated quantum code is well-formed, modern, safe, and
likely to run.
